      ...
      <br>
    	 ...
    	 <div class="col-md-2">
    		...
    		<img src="..\static\img\abhivyakti.jpg" alt="Pulpit Rock" style="width:100%;height:15em" class="img-thumbnail">
                ...
                <div style="color:black;font-size:15px;">
                    <p style="color:black;font-size:15px;">Exhibition of arts including arts made by Knitians and some other colleges and schools. Organised on 17th april 2016.</p>
    	...
    	<div class="col-md-2">
    		...
    		<img src="..\static\img\anunaad.jpg" alt="Pulpit Rock" style="width:100%;height:15em" class="img-thumbnail">
              ...
              <div style="color:black;font-size:20px;">
            <p style="color:black;font-size:15px;">ANUNAD is a cultural event held annually to commemorate the birth anniversary of Sir. M. Vishvesrayya which is now widely celebrated as Engineers' Day. </p>
              </div>
    		</img>
    	</div>
        <div class="col-md-1">
    	...
    	<div class="col-md-2">
            ...
            <p style="color:black;font-size:15px;">A Quiz was organised by team Q-FRAT on 13th of march 2016</p>
    		</div>
            </img>
    	</div>
        <br><br><br><br>
    ...
    <div class="row" style="background:#ECECEA;color:color:#404040;margin: 0px 0px 0px 5%;">
    	<div class="col-md-2">
    		...
    		<div style="color:black;">
            <p style="color:black;font-size:15px;">This camp was organised by drishticone team on 10th of april 2016.</p>
    		</div>
            </img>
    	</div>
        <div class="col-md-1">
    ...
    <div class="col-md-2">
            ...
            <p style="color:black;font-size:15px;">This council aims at encouraging and enhancing the vocational and writing skill of the students to the level where they can touch the horizon of inﬂuential writer and expert speaker.</p>
            </div>
            </img>
    </div>
    <div class="col-md-1">
...
The Applied Sciences and Humanities Department is an allied department which serves as a bedrock for the engineering departments of the Institute. The department takes care of core subjects like Mathematics, Physics, Chemistry and Professional communications. The department has competent and knowledgeable faculty and well equipped laboratories.
        ...
        <div class="col-md-2">
            ...
            <div style="color:black;">
            <p style="color:black;font-size:15px;">The Electronics Engineering Department offers both U.G. and P.G. (PartTime) courses. It has a well qualified faculty and technical supporting staff. All the laboratories of the department are well equipped with modern equipments. The department has also acquired stateoftheart equipments through World Bank assisted TEQIP programme.
