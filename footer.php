 ...
 <footer class="footer fot"  >
	  ...
	  <div class="row">
	   ...
	   <h1>	<a href="index.php" style="margin:10px;color:white;">Virtual knit</a></h1>
					...
					<a href="top.php" style="margin:7px;color:white;">About knit</a>
					
					<a href="category.php"  style="margin:7px;color:white;">About hostel</a>
					
					<a href="about.php"  style="margin:7px;color:white;">Student Activity</a>
					
					<a href="#"  style="margin:7px;color:white;">how to reach</a>
